...
const RAY_TXT = {
  intro: "Cada estación te plantea una pregunta con tres respuestas y cada respuesta te lleva a otra estación. Por el camino te encontrarás con episodios de la vida de los filósofos y con contradicciones entre tus propias respuestas. Al final llegarás a una terminal: la corriente con la que coinciden tus ideas. Cada viaje sale de una estación distinta, elegida al azar: puedes viajar tantas veces como quieras.",
  salida: "Hoy tu tren sale desde aquí. La estación de salida cambia en cada viaje.",
  todas: "Todas mis paradas", todasTit: "Todas tus paradas", todasPlano: "Todas tus paradas en el plano",
  todasAyuda: "El plano junta todas las estaciones por las que has pasado en todos tus viajes. Cuanto más grueso es un tramo, más veces lo has recorrido. El resto de la red sigue por descubrir.",
  veces: "veces", terminales: "Terminales",
  iniciar: "Iniciar viaje", otroViaje: "Nuevo viaje", miPlano: "Mi plano", abandonar: "← Abandonar el viaje", volver: "← Volver",
  viajes: "Viajes hechos:", finales: "Finales descubiertos:", estaciones: "Estaciones visitadas:",
  pregunta: "Estación", vida: "Vida de un filósofo", contradiccion: "Contradicción", final: "Terminal",
  chocan: "Tus respuestas que chocan:",
  coinciden: "Filósofos relacionados", estudia: "Estúdialo en la teoría", abierto: "Te queda abierto",
  paraPau: "Para la PAU (ejercicio 2: reflexión filosófica)", tuTexto: "Escribe aquí tu reflexión (200-300 palabras). Se guarda solo en este navegador.",
  guardado: "Guardado en este navegador.", palabras: "palabras",
  recorrido: "Tu recorrido", nuevo: "¡Final nuevo!", todos: "¡Has descubierto todos los finales de la red!", transbordo: "Transbordo",
  plano: "Tu recorrido en el plano", leyenda: "Leyenda", sinViajes: "Aquí se irá dibujando tu recorrido, estación a estación. El resto de la red está por descubrir.", verViaje: "Ver en el plano",
  ultimos: "Tus últimos viajes", ninguno: "Todavía no has hecho ningún viaje.", caidas: "Contradicciones en las que has caído",
  borrar: "Borrar mi progreso de la rayuela", seguro: "¿Seguro? Se borrarán tus viajes y tus reflexiones de este juego.",
  mapaAria: "Plano de tu recorrido por la rayuela filosófica", sinDescubrir: "Sin descubrir",
  aviso: "Alerta de coherencia", tension: "Tensión", antes: "Lo que dijiste antes:", ahora: "Lo que acabas de elegir:",
  queHaces: "¿Qué haces?", repensar: "Me lo repienso: vuelvo a elegir en esta estación.", rectificar: "Rectifico mi respuesta anterior:",
  mantener: "Mantengo las dos y sigo adelante (queda anotado).", ademas: "Además, choca con algo que dijiste antes",
  tensViaje: "Contradicciones y tensiones de este viaje", tensPau: "Elige una y explica, con argumentos, con cuál de las dos posturas te quedas y por qué."
};
