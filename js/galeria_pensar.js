"use strict";
/* ===== Galería · «Arte y pensamiento crítico» (1.º y 2.º de Bachillerato) — DOMINIO PÚBLICO / CC0 =====
   {f, t, pie, license, artist, page (Commons)}. Obras, grabados, ilusiones ópticas y fotografías sobre
   pensar por uno mismo, argumentar, falacias, sesgos, diálogo, medios, grupo y huella ecológica.
   Buscadas con tools/buscar_pd_galerias.py (Commons, solo PD/CC0/PDM). galeriaview.js las suma como grupo «PC».
   (24-09: primero fueron de 2.º ESO; su Galería se queda solo con los dibujos de los Cuentos para pensar.) */
